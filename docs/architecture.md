# DArc architecture — the Haskell layer

Load this when changing `Arc*.hs`, the archive format, or the UI. It is the half of the codebase the Rust port has not touched.
