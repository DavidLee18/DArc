...
-- HsLua uses C @double@ as @lua_Number@.
...
GC may in turn call some finalizers that will require come back to
the Haskell world.
...
-- | Loads a Lua script given as string parameter and executes it immediately. Use as:
--
