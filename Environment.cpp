...
// Change RTS settings, enabling compacting GC starting from 40 mb:
...
{
  struct tm *p;
  if (t==-1)  t=0;  // Otherwise we will get a crash :(
  p = localtime(&t);
...
// Create directories on the path to name
